...
public class FormularioCilindro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diámetro: 15,5 cm");

        jLabel2.setText("Altura: 42,4 cm");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        jTextField1.setText(String.valueOf(2 * Math.PI * radio * (altura + radio)));
        jTextField2.setText(String.valueOf(Math.PI * (radio * radio) * altura));
